...
def _web_server_up (event):
  log.info("Servidor web pronto. Definindo e registrando o handler NetworkViewHandler...")

  # --- A CLASSE É DEFINIDA AQUI DENTRO ---
  # Isso garante que este código só é executado DEPOIS que webcore está 100% pronto.
  ...
  # Agora registramos a classe que acabamos de definir
  event.server.set_handler("/network_view", NetworkViewHandler)

def launch ():
  log.info("Modulo my_web_viewer carregado. Aguardando pelo evento WebServerUp...")
